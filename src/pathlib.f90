...
public :: as_posix, drop_sep, expanduser, is_dir, is_file, is_exe, mkdir, parts, resolve, size_bytes !< functional API
...
with_suffix, &
resolve=>pathlib_resolve, same_file, is_exe=>pathlib_is_exe, &
